...
def creer_taches(mois: int, date_lundi: str, historique_produits: list = None) -> list:
    ...
    tache_email_coach = Task(
        description=(
            ...
            "date_semaine, la liste `planning` ci-dessous (OBLIGATOIRE : "
            "respecte exactement ces créneaux, jours et heures — optimisés "
            "pour la niche cuisine en France) et une liste `checklist` de "
            "courtes chaînes. Pour chaque créneau, remplis le champ "
            "'statut' avec 'Prêt' si le contenu a été généré avec succès, "
            "ou 'Échec : [motif]' sinon.\n\n"
            "Planning fixe à utiliser :\n"
            "- {jour: Lundi,    heure: 12h, plateforme: Instagram, type: Carousel produit 1 — recette classique}\n"
            "- {jour: Lundi,    heure: 15h, plateforme: TikTok,    type: Reel produit 1 classique}\n"
            "- {jour: Mardi,    heure: 18h, plateforme: Instagram, type: Story 'Le saviez-vous ?'}\n"
            "- {jour: Mercredi, heure: 12h, plateforme: Instagram, type: Carousel produit 2 — recette classique}\n"
            "- {jour: Mercredi, heure: 15h, plateforme: TikTok,    type: Reel produit 2 classique}\n"
            "- {jour: Jeudi,    heure: 18h, plateforme: Instagram, type: Story sondage}\n"
            "- {jour: Vendredi, heure: 12h, plateforme: Instagram, type: Carousel produit 1 — recette créative}\n"
            "- {jour: Vendredi, heure: 15h, plateforme: TikTok,    type: Reel produit 1 créatif}\n"
            "- {jour: Samedi,   heure: 9h,  plateforme: Instagram, type: Carousel produit 2 — recette créative}\n"
            "- {jour: Samedi,   heure: 12h, plateforme: TikTok,    type: Reel produit 2 créatif}\n"
            "- {jour: Dimanche, heure: 18h, plateforme: Instagram, type: Story récap semaine}\n\n"
            "2) appelle `uploader_dossier_drive` pour uploader le dossier "
